...
const (
// NonceSize is defined in ipcrypt.go
// HalfNonceSize is defined in ipcrypt.go
// TagSize is defined in ipcrypt.go
// PublicKeySize is defined in ipcrypt.go
// Curve25519_P is defined in ipcrypt.go
// Curve25519_A is defined in ipcrypt.go
// NonSquare is defined in ipcrypt.go
// QueryOverhead is defined in ipcrypt.go
// ResponseOverhead is defined in ipcrypt.go
